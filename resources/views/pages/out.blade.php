                        ...
                        <div class="row">
                            <ul class="nav nav-tabs ps-3" id="myTab" role="tablist">
                                <li class="nav-item ms-3" role="presentation">
                                    <a href="{{ route('attendance.in') }}" class="nav-link">Masuk</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('attendance.out') }}" class="nav-link active">Keluar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <form method="post" action="{{ route('attendance.out.submit') }}" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search" onsubmit="handleSubmit(event)">
                                @csrf
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <h2 class="mb-4">Mahasiswa Keluar</h1>
                </div>
